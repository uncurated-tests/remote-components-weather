...
export default function HomePage() {
  ...
  const newsArticles = [
    ...
    },
    {
      ...
      excerpt:
        "Solar and wind power generation surpasses fossil fuels for the first time in recorded history.",
      image: "/placeholder.svg?height=200&width=300",
  ...
  const trendingArticles = [
    {
      title: "Electric Vehicle Sales Surge 300% This Quarter",
      readTime: "2 min",
      comments: 45,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <RemoteComponent isolate={false} src="/components/header?q=foo" />
                ...
                {categories.map((category) => (
                  ...
                  >
                    <div className="flex items-center gap-2 w-full">
                      <div
                        className={`w-3 h-3 rounded-full ${category.color} shadow-lg`}
                      />
